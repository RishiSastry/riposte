...
> **New here?** Start with the [README](./README.md) for the pitch and results, or the essay
> [How I evaluate coding agents that write DSLs](./writeup/agent-evals-for-dsls.md) for the
> motivation. This file is the engineering guide to the code.
